      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> +09 984133905</a>
              <span class="divider">|</span>
              <a href="#"><span class="mai-mail text-primary"></span> healthy@gmail.com</a>
            </div>
          </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            @auth
              ...
              blue;color:white;" href="{{url('myappointment')}}">My Appointment</a>
            </li>
                  <x-app-layout>
</x-app-layout>
            @else
...
<div align="center" style="padding:70px;">
      <table>
              ...
              <tr style="background-color:lightgreen; color:black;" align="center">
